...
public class Lance {
    ...
    public void imprimeMelhorLance() {
        if (ofertas.isEmpty()) {
            ...
            Comprador melhorComprador = compradores.get(maior);
            System.out.println(melhorComprador.getNome() + " ofereceu " + ofertas.get(maior) + " (" + momentos + ")");
        }
    }
}